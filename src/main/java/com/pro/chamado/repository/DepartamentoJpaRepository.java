...
import com.pro.chamado.model.Departamento;
 ...
 * @author paulo
 */
public class DepartamentoJpaRepository implements Serializable {

    public DepartamentoJpaRepository(EntityManagerFactory emf) {
        this.emf = emf;
    }
